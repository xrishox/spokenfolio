...
struct SiriVoiceAsset: Hashable, Sendable {
  let id: String
  let name: String
  ...
  var supportsNarration: Bool { styles.contains("narration") }
...
enum SiriVoiceCatalog {
  static let requiredSampleRate = 48_000
  ...
  static func defaultSearchDirectories(
  ...
  static func preferred(_ assets: [SiriVoiceAsset]) -> SiriVoiceAsset? {
    assets.min {
