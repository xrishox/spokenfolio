...
package struct M4BAudiobookWriter: AudiobookFormatWriter {
  ...
  package func makeChapterEncoder(artifactURL: URL) throws -> any ChapterAudioEncoding {
    try AACChapterEncoder(artifactURL: artifactURL, settings: settings, fingerprint: fingerprint)
  }

  package func validateArtifact(at url: URL) throws -> ChapterArtifact {
