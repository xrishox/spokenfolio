...
package struct AudiobookMetadata: Sendable, Equatable {
  ...
  /// The selected narration voice's display name.
...
package struct M4BChapterArtifact: Sendable, Equatable {
  package let url: URL
...
package protocol M4BChapterEncoding: AnyObject {
...
/// Narrow M4B/AAC seam retained for orchestration tests. It deliberately does
/// not claim to be a generic publication-output plugin interface.
package protocol M4BWriting: Sendable {
